...
<html lang="en-US">
  <head>
    ...
    <title>isPromise | Ts.ED - A Node.js and TypeScript Framework on top of Express.</title>
  ...
  <body>
    <div id="app" data-server-rendered="true"><div class="theme-container"><header class="navbar --fluid"><div class="container"><div class="sidebar-button"><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" viewBox="0 0 448 512" class="icon"><path fill="currentColor" d="M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z"></path></svg></div> <a href="/" class="home-link router-link-active"><!----> <span class="site-name">
      Ts.ED
          ...
          Jest
        </a></li></ul></div></div><div class="nav-item"><a href="http://v4.tsed.io" target="_blank" rel="noopener noreferrer" class="nav-link external">4.x</a></div></nav>  <ul class="sidebar-links"><li><div class="sidebar-group first"><p class="sidebar-heading open"><span>isPromise</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/api/schema/node_modules/@tsed/core/utils/isPromise.html#overview" class="sidebar-link">Overview</a><ul class="sidebar-sub-headers"></ul></li><li><a href="/api/schema/node_modules/@tsed/core/utils/isPromise.html#description" class="sidebar-link">Description</a><ul class="sidebar-sub-headers"></ul></li></ul></div></li></ul> </aside> <div class="page"><article class="container"> <div class="content__default"><h1 id="ispromise"><a href="#ispromise" class="header-anchor">#</a> isPromise <span class="badge function" style="vertical-align:top;" data-v-2fb5e6d2>Function</span></h1> <section class="symbol-info"><table class="is-full-width"><tbody><tr><th>Module</th><td><div class="lang-typescript"><span class="token keyword">import</span> { isPromise } <span class="token keyword">from</span> <span class="token string">&quot;@tsed/schema/node_modules/@tsed/core/src/utils/ObjectUtils&quot;</span></div></td></tr><tr><th>Source</th><td><a href="https://github.com/TypedProject/tsed/blob/v5.37.1/packages/schema/node_modules/@tsed/core/src/utils/ObjectUtils.ts#L0-L0">/packages/schema/node_modules/@tsed/core/src/utils/ObjectUtils.ts</a></td></tr></tbody></table></section> <h2 id="overview"><a href="#overview" class="header-anchor">#</a> Overview</h2> <div class="language-typescript"><pre class="language-typescript"><code class="typescript-lang ">function <span class="token function">isPromise</span><span class="token punctuation">(</span>target<span class="token punctuation">:</span> <span class="token keyword">any</span><span class="token punctuation">)</span><span class="token punctuation">:</span> <span class="token keyword">boolean</span><span class="token punctuation">;</span></code></pre></div> <h2 id="description"><a href="#description" class="header-anchor">#</a> Description</h2> <div><p>Tests to see if the object is an ES2015 (ES6) Promise</p></div></div> <!----> <section class="other-topics"><ul><h3 class="heading">
    ...
    <script src="/assets/js/app.d254febf.js" defer></script><script src="/assets/js/4.8cf340e3.js" defer></script><script src="/assets/js/1.a902bc18.js" defer></script><script src="/assets/js/597.a94eaedc.js" defer></script>
  </body>
</html>
